...
Use the subject line: \texttt{CA-I Assignment-I 2025}.

\section{$\chi^2$ Test}
The file chi2.csv provided to you contains $3$ data sets, A, B and C. Perform $\chi^2$ test on each of these data sets, and interpret the results.
